  ...
  */
  async buildRidePOI() {
    return await this.getPOIS().then((rideData) => {
      ...
      // Work around for the 2 new rides Kondala & Kondaa
      poi['ae675412-bb70-48b9-9acf-e815fc9322e0'] = {
        name: 'Kondala',
        id: `${this.config.name}_` + 'ae675412-bb70-48b9-9acf-e815fc9322e0',
        location: {
          latitude: null,
          longitude: null,
        },
      ...
      poi['dfb82971-7cc2-4153-a57f-e4a54f222b93'] = {
        name: 'Kondaa',
        id: `${this.config.name}_` + 'dfb82971-7cc2-4153-a57f-e4a54f222b93',
        location: {
          latitude: null,
          longitude: null,
        },
