...
export class WalibiHolland {
  ...
  * This data contains all the Queues in Walibi Holland
  * @return {string} WaitTimes
  */
  getWaitTime() {
    return this.getPOIS().then((rides) => Promise.resolve(rides));
  }
};
